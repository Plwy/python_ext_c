    ...
    int mapping_type)
{
    int i;
    int x, y, k;
    int tri_p0_ind, tri_p1_ind, tri_p2_ind;         //模型三角面的索引
    int tex_tri_p0_ind, tex_tri_p1_ind, tex_tri_p2_ind;     //纹理图三角坐标
    point p0, p1, p2, p;
    ...
    for(i = 0; i < ntri; i++)
    {
        ...
        //（一般情况下面的索引和纹理索引一致，即tex_triangles = triangles）
